      ...
      <div className="container mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="inline-flex items-center gap-2 rounded-md border border-accent/20 bg-accent/10 px-4 py-2">
            ...
            <div className="space-y-4 pt-4">
              {[
                ...
                <div 
                  key={feature.text} 
                  className="group flex items-center gap-4 rounded-md border border-border/50 bg-card/50 p-4 backdrop-blur-sm transition-all duration-500 hover:border-accent/30 hover:bg-card hover:shadow-glow-accent animate-fade-in-up"
                  style={{ animationDelay: `${feature.delay}ms` }}
                >
                  <div className="relative flex-shrink-0">
                    <div className="absolute inset-0 rounded-md bg-accent/25 opacity-50 blur-md transition-opacity duration-300 group-hover:opacity-80" />
                    <div className="relative flex h-10 w-10 items-center justify-center rounded-md bg-gradient-accent transition-all duration-300 group-hover:scale-105">
            ...
            <Card className="relative group bg-gradient-to-br from-card to-card/50 border-border/50 backdrop-blur-sm overflow-hidden hover:shadow-glow-primary transition-all duration-500 hover:scale-[1.02]">
              ...
              <div className="relative bg-gradient-to-r from-primary/20 to-secondary/20 backdrop-blur-sm p-4 flex items-center justify-between border-b border-border/50">
                <div className="flex items-center gap-2">
                  <div className="h-3 w-3 rounded-sm bg-red-500 animate-pulse"></div>
                  <div className="h-3 w-3 rounded-sm bg-yellow-500 animate-pulse [animation-delay:200ms]"></div>
                  <div className="h-3 w-3 rounded-sm bg-green-500 animate-pulse [animation-delay:400ms]"></div>
